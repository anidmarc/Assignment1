...
import com.assignment1.util.WaitTime;
...
public class Base {
	...
	public Base() {
		...
		try {
			prop = new Properties();
			FileInputStream ip = new FileInputStream("D:\\Aniruddha_WorkSpace\\Assignment1-master\\Assignment1-master\\Assignment1\\src\\main\\java\\com\\assignment1\\config\\config.properties");
			prop.load(ip);
